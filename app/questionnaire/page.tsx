...
export default function Questionnaire() {
    ...
    return (
      <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "4rem 1.5rem" }}>
        <div style={{ maxWidth: "480px", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: isMobile ? "2.5rem" : "3.5rem", fontWeight: 800, textTransform: "uppercase", lineHeight: 0.95, marginBottom: "1.5rem" }}>
  ...
  return (
    <div style={{ minHeight: "100vh", padding: isMobile ? "5rem 1.5rem 3rem" : "6rem 2rem 4rem" }}>
      <div style={{ maxWidth: "580px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: isMobile ? "2.2rem" : "3rem", fontWeight: 800, textTransform: "uppercase", lineHeight: 0.95, marginBottom: "2rem" }}>
            {step === 1 && "QUI ES-TU ?"}
            {step === 2 && "TON NIVEAU"}
            {step === 3 && "TON OBJECTIF"}
        ...
        {step === 1 && fieldGroup(
          <>
            ...
            <input type="text" value={form.honeypot} onChange={e => set("honeypot", e.target.value)} style={{ display: "none" }} tabIndex={-1} aria-hidden="true" />
          </>
        )}
        ...
        {step === 3 && fieldGroup(
          <>
            ...
            <div>
              ...
              <textarea placeholder="Dos fragile, genou opéré... ou rien du tout !" value={form.blessures} onChange={e => set("blessures", e.target.value)} rows={3} style={{ ...inputStyle, resize: "vertical" }} />
            </div>
          </>
        )}
        ...
        {step === 4 && fieldGroup(
          <>
            <div>
              ...
              <textarea placeholder="Qu'est-ce qui t'a décidée à te lancer ?" value={form.pourquoi} onChange={e => set("pourquoi", e.target.value)} rows={3} style={{ ...inputStyle, resize: "vertical" }} />
            </div>
            ...
            <div>
              ...
              <textarea placeholder="Tout ce que tu veux ajouter..." value={form.message} onChange={e => set("message", e.target.value)} rows={3} style={{ ...inputStyle, resize: "vertical" }} />
            </div>
          </>
        )}
