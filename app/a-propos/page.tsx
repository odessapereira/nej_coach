  ...
  return (
    <main style={{ paddingTop: "5rem" }}>
      ...
      <section style={{
        ...
        minHeight: "70vh", borderBottom: "1px solid rgba(28,22,18,0.08)"
      }}>
        <div style={{ padding: "5rem 3rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "5rem", fontWeight: 800, textTransform: "uppercase", lineHeight: 0.92, marginBottom: "2rem" }}>
            JE SUIS NAJIYA.<br />
        ...
        <div style={{ background: "var(--sable-dark)", position: "relative", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "16rem", fontWeight: 800, color: "rgba(28,22,18,0.04)", textTransform: "uppercase", fontStyle: "italic", userSelect: "none", lineHeight: 1 }}>
            N
          </span>
      ...
      {/* HISTOIRE */}
      <section style={{ padding: "6rem 3rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "start" }}>
        <div>
          <div style={{ fontSize: "0.68rem", fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--rose)", marginBottom: "1.5rem", display: "flex", alignItems: "center", gap: "8px" }}>
            <span style={{ width: "20px", height: "1.5px", background: "var(--rose)", display: "inline-block" }} />
            Mon parcours
          </div>
          <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "3.5rem", fontWeight: 800, textTransform: "uppercase", lineHeight: 0.95, marginBottom: "2rem" }}>
            UN VIRAGE.<br />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <p style={{ fontSize: "0.9rem", fontWeight: 300, lineHeight: 1.95, color: "var(--muted)" }}>
          ...
          <p style={{ fontSize: "0.9rem", fontWeight: 300, lineHeight: 1.95, color: "var(--muted)" }}>
            Mais il y avait cette autre chose, constante, qui ne me lâchait pas. Le sport. Pas comme une discipline — comme une langue. Une façon d'exister, de me sentir forte, vivante, capable. Chaque séance était une conversation avec moi-même.
          </p>
          <p style={{ fontSize: "0.9rem", fontWeight: 300, lineHeight: 1.95, color: "var(--muted)" }}>
            Alors j'ai fait le choix qui demande du courage : <em style={{ color: "var(--brun)", fontStyle: "normal" }}>tout recommencer.</em> Pas par caprice — par lucidité. J'ai arrêté les études d'infirmière, obtenu mon diplôme de Personal Trainer, et lancé Nej Coach avec une seule idée en tête : être la coach que j'aurais voulu avoir.
          </p>
          <p style={{ fontSize: "0.9rem", fontWeight: 300, lineHeight: 1.95, color: "var(--muted)" }}>
      ...
      <section style={{ padding: "0 3rem 6rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: "rgba(28,22,18,0.08)" }}>
          {[
      ...
      {/* FORMATIONS */}
      <section style={{ padding: "0 3rem 6rem" }}>
        <div style={{ background: "var(--sable-dark)", padding: "3.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: "0.68rem", fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--rose)", marginBottom: "1.5rem", display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ width: "20px", height: "1.5px", background: "var(--rose)", display: "inline-block" }} />
              Ce qui arrive
            </div>
            <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "3rem", fontWeight: 800, textTransform: "uppercase", lineHeight: 0.95, marginBottom: "1rem" }}>
              JE NE M'ARRÊTE<br />
            ...
            <p style={{ fontSize: "0.88rem", fontWeight: 300, lineHeight: 1.85, color: "var(--muted)" }}>
              Accompagner des femmes de tous profils demande une expertise sans cesse renouvelée. Je me forme en continu pour pouvoir m'adapter à chaque situation, chaque corps, chaque objectif.
            </p>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5px", background: "rgba(28,22,18,0.08)" }}>
            {[
              ...
              <div key={f.label} style={{ background: "var(--blanc)", padding: "1.1rem 1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <span style={{
                  fontSize: "0.65rem", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase",
                  padding: "0.25rem 0.7rem",
                  color: f.statut === "Diplômée" ? "var(--brun)" : f.statut === "En cours" ? "var(--rose)" : "var(--muted)",
                  background: f.statut === "Diplômée" ? "rgba(28,22,18,0.08)" : f.statut === "En cours" ? "var(--rose-pale)" : "rgba(28,22,18,0.04)",
                }}>
                  {f.statut}
                </span>
              </div>
      ...
      <section style={{ margin: "0 3rem 5rem", background: "var(--brun)", padding: "3.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "2rem" }}>
        <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "2rem", fontWeight: 800, textTransform: "uppercase", color: "var(--blanc)", lineHeight: 0.95, maxWidth: "400px" }}>
          PRÊTE À ÉCRIRE<br />
          <em style={{ fontStyle: "italic", color: "var(--rose-light)" }}>TON HISTOIRE ?</em>
        </h2>
        <a href="/questionnaire" style={{ background: "var(--sable)", color: "var(--brun)", padding: "1rem 2.5rem", fontSize: "0.72rem", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", textDecoration: "none", whiteSpace: "nowrap" }}>
          Faire mon bilan →
        </a>
      </section>
